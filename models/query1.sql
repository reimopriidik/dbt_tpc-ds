...
STATE can be found
    in CUSTOMER_ADDRESS table as CA_STATE column (not so relevant)
    in STORE table as S_STATE column

SR_RETURN_AMT can be found
...
-- "Finished running 1 table model in 0 hours 1 minutes and 22.33 seconds (82.33s)."